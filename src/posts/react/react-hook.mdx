...
<img
  width="596"
  alt="스크린샷 2024-01-01 오후 7 27 02"
  src="https://github.com/jeongdopark/H-Logger/assets/72500346/0713067f-7dbb-49f5-aaf4-9714d8ddaf40"
/>
...
메인 스레드, 합성 스레드, GPU 프로세스 각 단계별 어떤 과정이 일어나는지 살펴보며 최적화까지 확장하여 살펴보겠습니다.

## 1. Parse

<img
  width="532"
  alt="스크린샷 2024-01-01 오후 7 35 25"
  src="https://github.com/jeongdopark/H-Logger/assets/72500346/8091045e-8f20-4456-aa91-4d96629a462f"
/>

HTML 파일을 파싱 하여 DOM 객체로 변환하고 DOM Tree를 생성합니다.
...
이를 통해 파싱 된 스타일 정보를 기반으로 ComputedStyle (CSSOM)객체가 생성됩니다.
...
Pre-Paint 단계에서는 CSS 속성 중 위의 네 가지 속성에 대해서 Property Tree를 생성합니다.
...
해당 paint 메소드를 사용해서 Paint Records를 생성합니다.
...
레이어는 Paint Layer와 Graphic Layer 두 가지가 있습니다.
...
![img]("https://github.com/jeongdopark/H-Logger/assets/72500346/7cfc1cb7-ab31-475b-b683-a0c09251e0eb")
...
Raster 과정에서 레이어와 Property Tree 정보를 바탕으로 Quad가 생성됩니다.
...
모든 Quad는 Compositor Frame으로 묶여 GPU Process로 전달됩니다.
