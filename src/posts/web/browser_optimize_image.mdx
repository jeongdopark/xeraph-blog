...
description: "블로그 개발 후기 - 이미지를 통한 성능 개선"
date: "2024-01-18"
---
...
이미지의 포맷 webp로 변환, 사이즈 옵션 등 Next에서 이미지 최적화에 신경을 많이 쓰고 있는 것을 알 수 있었고 편리하게 적용할 수 있었습니다.

간단한 코드 수정으로도 성능 개선 효과를 확인할 수 있었고 디테일한 재미가 쏠쏠했습니다.

다양한 최적화 방법을 학습하고 블로그에 적용하며 실습해 나아가야겠습니다 :-)
