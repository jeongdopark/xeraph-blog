---
title: "렌더링 패턴 [ CRS, SSR ] - 1"
description: "React 18 업데이트 이후 개선된 렌더링 아키텍쳐"
date: "2024-03-16"
---

> Client Side Rendering, Server Side Rendering의 특징과 한계점에 대해 다룹니다. <br/>
> 다음 글에서는 React 18 업데이트 이후, Suspense를 활용한 Streaming Server Rendering에 대해 다룹니다.
...
렌더링 패턴 <Highlight text="CSR"/>, <Highlight text="SSR"/>, <Highlight text="Streaming Server Rendering"/>에 대해 알아보겠습니다.
...
<CustomImage
  src="https://github.com/jeongdopark/H-Logger/assets/72500346/1b9c5bc0-90d8-486a-816d-09adab3d15ab"
  width={600}
  height={400}
/>
...
> 3️⃣ 서비스의 모든 JS 파일을 로드합니다.<br/>
> 4️⃣ 로드가 완료되면 렌더링 합니다.<br/>
...
<CustomImage
  src="https://github.com/jeongdopark/H-Logger/assets/72500346/82a7ce9b-7f52-467f-824a-81a25432a353"
  width={600}
  height={400}
/>
...
- https://www.youtube.com/watch?v=Q98l5o1y3aos
