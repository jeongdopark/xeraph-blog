...
description: "CSS를 통한 브라우저 렌더링 최적화"
date: "2024-01-22"
---
...
<Link link="https://www.explainthis.io/en/swe/repaint-and-reflow" replace="Reflow" /> > Repaint > <Link
  link="https://web.dev/articles/stick-to-compositor-only-properties-and-manage-layer-count?hl=en"
